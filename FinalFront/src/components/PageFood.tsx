...
import { Box, Button, Flex, HStack, Heading,Menu,MenuButton,MenuItem,MenuList,Text 
,Card, CardHeader, CardBody, CardFooter, Image,Stack} from '@chakra-ui/react'
  ...
  return (
    <Box >
        ...
        justifyContent="space-around"
         ...
         >
            < Text fontFamily="Xanh Mono" fontWeight={"bold"} fontSize="2xl">section</Text>
            <HStack>
                <Text  fontFamily="Xanh Mono" fontWeight={"bold"}   >City:</Text>
                <Menu >
  <MenuButton 
  border={"solid"}
  borderWidth='1px'
